  ...
  const steps = [
    {
      ...
      detail: `Click the direct link button below to open ${subscription.name}'s cancellation page in a new tab.`,
    },
    {
        ...
        {onMarkCanceled && (
          <div className="pt-2">
            <Button
              ...
              className="w-full text-xs h-9 text-emerald-600 dark:text-emerald-400 border-emerald-500/30 hover:bg-emerald-500/10"
            >
