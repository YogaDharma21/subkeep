...
export function CancellationGuideModal({
  ...
  const steps = [
    {
      ...
      detail: hasCustomUrl
        ? `Click the direct link button below to open ${subscription.name}'s cancellation page.`
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md max-h-[88vh] overflow-y-auto flex flex-col gap-3.5 rounded-lg p-5">
