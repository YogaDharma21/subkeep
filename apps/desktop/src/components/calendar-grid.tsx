...
export function CalendarGrid({ subscriptions, onSelectSubscription }: CalendarGridProps) {
              ...
              selectedEvents.map(({ subscription: sub, eventType }) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => onSelectSubscription?.(sub._id)}
                    className="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-muted/60 transition-colors"
                  >
                    <div
